...
export class AddProductComponent {
  ...
  constructor(private httpClient: HttpClient, private formBuilder: FormBuilder, private dataService: ProductsService) {
  ...
  newProduct(product_name:string,description:string,price:string, stock:string,category_id:string){
    let product = {
  ...
  uploadImage(): any {
    ...
    this.httpClient.post<any>(`${backendEndpoint}/upload`, formData)
      .subscribe(
        (response) => {
